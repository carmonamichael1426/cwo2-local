...
class FPDF
{
    ...
    {
        // LOGO
        $this->Image(getcwd() . '/assets/img/alturas.png', 10, 6, 30);
        $this->Cell(30);
        $this->SetFont('Arial', '', 12);
        // Move to the right
        $this->Cell(25);
        // Title
        $this->Cell(17, 5, 'Cash With Order Monitoring Report', 0, 0, 'C');
        $this->SetFont('Arial', '', 10);
        $this->Cell(267, 5, date("F d, Y - h:i:s A"), 0, 0, 'R');
        $this->Ln();
        $this->Line(10, 16, 347 - 0, 16);
        $this->Ln();
        $this->Ln();
    }
