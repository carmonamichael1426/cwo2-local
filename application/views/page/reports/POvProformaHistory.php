...
<div class="content-wrapper body-bg" ng-controller="transactionhistory-controller">
    <!-- Main content -->
    <div class="content">
                        ...
                        <div class="card-header bg-dark rounded-0">
                            <div class="content-header" style="padding: 0px">
                                <div class="panel panel-default">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="panel-body"><i class="fas fa-file-alt"></i> <strong>PO VS PROFORMA HISTORY</strong></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
