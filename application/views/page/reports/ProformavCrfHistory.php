...
<div class="content-wrapper body-bg" ng-controller="proformavscrfhistory-controller">
    <!-- Main content -->
    <div class="content">
                        ...
                        <div class="card-header bg-dark rounded-0">
                            <div class="content-header" style="padding: 0px">
                                <div class="panel panel-default">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="panel-body"><i class="fas fa-file-alt"></i> <strong>PROFORMA VS CRF HISTORY</strong></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table id="transactionHistoryTable" class="table table-sm font-small table-bordered table-hover">
                                    <thead class="bg-dark">
                                        <tr>
                                            ...
                                            <th scope="col" class="text-center">Document A</th>
                                            <th scope="col" class="text-center">Document B</th>
                                    ...
                                    <tbody>
                                        <tr ng-cloak ng-repeat="t in tHistory">
                                            ...
                                            <td class="text-center">{{ t.document2 }}</td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="btn-group" role="group">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="" style="margin-right: 50px;">
                                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#" ng-click="viewDocument(t)">
                                                            <i class="fas fa-search" style="color: green;"></i> View Document
                                                        </a>   
                                                        <?php if ($this->session->userdata('userType') == 'Accounting' || $this->session->userdata('userType') == 'Admin') : ?>
                                                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#" ng-click="deleteDocument(t)">
                                                                <i class="fas fa-trash-alt" style="color: red;"></i> Delete Document
                                                            </a>      
                                                        <?php endif;?>                                     
                                                    </div>                                                                                                    
                                                </div>    
