...
<body id="login">
    <!-- <a href="<?php echo base_url(); ?>admin_login" class="ml-1" title="Admin Dashboard Login"><i class="fas fa-user-shield"></i> </a> -->
    <div class="container container-style" ng-controller="login-controller">
        <div class="card rounded-0 card-style">
            <div class="card-body">
                <img src="<?php echo base_url(); ?>assets/img/CWO-PORTAL.png" alt="CWO" class="mb-3">
